(()=>{var f=class{static floatTo16BitPCM(e){let t=new ArrayBuffer(e.length*2),s=new DataView(t),n=0;for(let r=0;r<e.length;r++,n+=2){let a=Math.max(-1,Math.min(1,e[r]));s.setInt16(n,a<0?a*32768:a*32767,!0)}return t}static mergeBuffers(e,t){let s=new Uint8Array(e.byteLength+t.byteLength);return s.set(new Uint8Array(e),0),s.set(new Uint8Array(t),e.byteLength),s.buffer}_packData(e,t){return[new Uint8Array([t,t>>8]),new Uint8Array([t,t>>8,t>>16,t>>24])][e]}pack(e,t){if(t?.bitsPerSample)if(t?.channels){if(!t?.data)throw new Error('Missing "data"')}else throw new Error('Missing "channels"');else throw new Error('Missing "bitsPerSample"');let{bitsPerSample:s,channels:n,data:r}=t,a=["RIFF",this._packData(1,52),"WAVE","fmt ",this._packData(1,16),this._packData(0,1),this._packData(0,n.length),this._packData(1,e),this._packData(1,e*n.length*s/8),this._packData(0,n.length*s/8),this._packData(0,s),"data",this._packData(1,n[0].length*n.length*s/8),r],o=new Blob(a,{type:"audio/mpeg"}),l=URL.createObjectURL(o);return{blob:o,url:l,channelCount:n.length,sampleRate:e,duration:r.byteLength/(n.length*e*2)}}};globalThis.WavPacker=f;var I=[4186.01,4434.92,4698.63,4978.03,5274.04,5587.65,5919.91,6271.93,6644.88,7040,7458.62,7902.13],q=["C","C#","D","D#","E","F","F#","G","G#","A","A#","B"],m=[],b=[];for(let h=1;h<=8;h++)for(let e=0;e<I.length;e++){let t=I[e];m.push(t/Math.pow(2,8-h)),b.push(q[e]+h)}var A=[32,2e3],S=m.filter((h,e)=>m[e]>A[0]&&m[e]<A[1]),D=b.filter((h,e)=>m[e]>A[0]&&m[e]<A[1]);var g=class h{static getFrequencies(e,t,s,n="frequency",r=-100,a=-30){s||(s=new Float32Array(e.frequencyBinCount),e.getFloatFrequencyData(s));let o=t/2,l=1/s.length*o,u,i,c;if(n==="music"||n==="voice"){let p=n==="voice"?S:m,d=Array(p.length).fill(r);for(let v=0;v<s.length;v++){let F=v*l,B=s[v];for(let y=p.length-1;y>=0;y--)if(F>p[y]){d[y]=Math.max(d[y],B);break}}u=d,i=n==="voice"?S:m,c=n==="voice"?D:b}else u=Array.from(s),i=u.map((p,d)=>l*d),c=i.map(p=>`${p.toFixed(2)} Hz`);let w=u.map(p=>Math.max(0,Math.min((p-r)/(a-r),1)));return{values:new Float32Array(w),frequencies:i,labels:c}}constructor(e,t=null){if(this.fftResults=[],t){let{length:s,sampleRate:n}=t,r=new OfflineAudioContext({length:s,sampleRate:n}),a=r.createBufferSource();a.buffer=t;let o=r.createAnalyser();o.fftSize=8192,o.smoothingTimeConstant=.1,a.connect(o);let l=1/60,u=s/n,i=c=>{let w=l*c;w<u&&r.suspend(w).then(()=>{let k=new Float32Array(o.frequencyBinCount);o.getFloatFrequencyData(k),this.fftResults.push(k),i(c+1)}),c===1?r.startRendering():r.resume()};a.start(0),i(1),this.audio=e,this.context=r,this.analyser=o,this.sampleRate=n,this.audioBuffer=t}else{let s=new AudioContext,n=s.createMediaElementSource(e),r=s.createAnalyser();r.fftSize=8192,r.smoothingTimeConstant=.1,n.connect(r),r.connect(s.destination),this.audio=e,this.context=s,this.analyser=r,this.sampleRate=this.context.sampleRate,this.audioBuffer=null}}getFrequencies(e="frequency",t=-100,s=-30){let n=null;if(this.audioBuffer&&this.fftResults.length){let r=this.audio.currentTime/this.audio.duration,a=Math.min(r*this.fftResults.length|0,this.fftResults.length-1);n=this.fftResults[a]}return h.getFrequencies(this.analyser,this.sampleRate,n,e,t,s)}async resumeIfSuspended(){return this.context.state==="suspended"&&await this.context.resume(),!0}};globalThis.AudioAnalysis=g;var E=`
